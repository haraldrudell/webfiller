...
function collect(viewStructure, ext) {
	...
	function resolveFragment() {
		...
		if (typeof renderFunction == 'string') throw Error('Unknown fragment:\'' + fragment + '\' ' + renderFunction)
		var theDomain = renderFunction.getDomain()
		if (typeof domain != 'string' || !domain) throw Error('Fragment missing domain:\'' + fragment + '\'')
