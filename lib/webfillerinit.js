...
function initWebFiller(defaults, opts, callback) {
	...
	viewloader.setParameters(viewStructure, opts.defExt, fragmentcache.getCache())
	filewriter.write(opts.webFillerFolder, viewStructure, defaultViewName, opts.defExtwriteDone)
